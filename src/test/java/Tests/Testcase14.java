...
public class Testcase14 extends BaseClass
{
	...
	public void registerWhileCheckout() throws InterruptedException
	{
		try 
		{
			test=extent.createTest("Register whlile Checkout").assignCategory("Positive Testing").assignAuthor("Bharath Reddy");
			...
			enterData(signuploginpageobject.SignupEmail,"testcase14@gmail.com");
	...
	//		enterData(signuploginpageobject.Name,config.getProperty("Name"));
			enterData(signuploginpageobject.Password,"testcase14@gmail.com");
