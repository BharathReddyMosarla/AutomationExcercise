...
public class Testcase15 extends BaseClass
{
	...
	public void regBeforeCheckout()
	{
		try 
		{
			test=extent.createTest("Register Before Checkout").assignCategory("Positive Testing").assignAuthor("Bharath Reddy");
			...
			enterData(signuploginpageobject.SignupEmail,"testcase15@gmail.com");
			...
			enterData(signuploginpageobject.Password,"testcase15@gmail.com");
